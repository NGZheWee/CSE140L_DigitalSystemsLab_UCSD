...
entity struct_diag is
    ...
    port(
        ...
        Month1disp      : out    vl_logic_vector(6 downto 0);
        Month0disp      : out    vl_logic_vector(6 downto 0);
        Date1disp       : out    vl_logic_vector(6 downto 0);
        Date0disp       : out    vl_logic_vector(6 downto 0);
        Buzz            : out    vl_logic
    );
